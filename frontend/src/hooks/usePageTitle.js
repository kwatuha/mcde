...
const routeTitles = {
  ...
  '/engineer-workspace/certificates': { title: 'Certificates', subtitle: 'Engineer workspace' },
  '/engineer-workspace/progress-photos': { title: 'Progress Photos', subtitle: 'Contractor milestone photos' },
