...
const routeTitles = {
  ...
  '/resident-engineer-workspace': { title: 'Resident Engineer Workspace', subtitle: 'Site projects, compliance, photos & first certificate sign-off' },
  '/resident-engineer-workspace/projects': { title: 'Project Registry', subtitle: 'Resident Engineer workspace' },
  '/resident-engineer-workspace/payments': { title: 'Payment Requests', subtitle: 'Resident Engineer workspace' },
  '/resident-engineer-workspace/certificates': { title: 'Payment Certificates', subtitle: 'Resident Engineer — first approval step' },
  '/resident-engineer-workspace/progress-photos': { title: 'Progress Photos', subtitle: 'Resident Engineer workspace' },
  '/chief-engineer-workspace': { title: 'Chief Engineer Workspace', subtitle: 'Second certificate approval after Resident Engineer' },
  '/chief-engineer-workspace/projects': { title: 'Project Registry', subtitle: 'Chief Engineer workspace' },
  '/chief-engineer-workspace/payments': { title: 'Payment Requests', subtitle: 'Chief Engineer workspace' },
  '/chief-engineer-workspace/certificates': { title: 'Payment Certificates', subtitle: 'Chief Engineer — second approval step' },
  '/chief-engineer-workspace/progress-photos': { title: 'Progress Photos', subtitle: 'Chief Engineer workspace' },
  '/co-finance-workspace': { title: 'Co-Finance Workspace', subtitle: 'County finance review after engineer approvals' },
  '/co-finance-workspace/projects': { title: 'Project Registry', subtitle: 'Co-finance workspace' },
  '/co-finance-workspace/payments': { title: 'Payment Requests', subtitle: 'Co-finance workspace' },
  '/co-finance-workspace/certificates': { title: 'Payment Certificates', subtitle: 'Co-finance final approval' },
  '/co-finance-workspace/finance': { title: 'County Finance', subtitle: 'Co-finance workspace' },
  '/village-workspace': { title: 'Village M&E Workspace', subtitle: 'Sublocation monitoring, photos, and documents' },
  '/ward-workspace': { title: 'Ward M&E Workspace', subtitle: 'Ward monitoring review and village report workflow' },
  '/subcounty-workspace': { title: 'Sub-County M&E Workspace', subtitle: 'Sub-county monitoring review — return to ward or forward to chief' },
  '/chief-workspace': { title: 'Department Chief M&E Workspace', subtitle: 'Final monitoring approval and public project release (department-scoped)' },
