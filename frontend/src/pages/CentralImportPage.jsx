...
const STATIC_TEMPLATE_PATHS = {
  // Keep static templates as fallback only; project templates are generated by the API
  // so financial-year dropdowns reflect the current system setup.
};
...
const TEMPLATE_HEADER_VARIANTS = {
  projects: {
    ...
    department: ['County Department', 'Department', 'Implementing Department'],
              ...
              >
                ...
                <Grid container spacing={1.5}>
                  ...
                  <Grid item xs={12} md={6}>
                    <Card variant="outlined" sx={{ '& .MuiCardContent-root': { py: 1.5, '&:last-child': { pb: 1.5 } } }}>
                      <CardContent>
                        <Typography variant="body2" fontWeight={600} gutterBottom sx={{ fontSize: '0.875rem' }}>
                          County Departments ({mappingSummary.departments.existing.length + mappingSummary.departments.new.length})
                        </Typography>
                  ...
                  {/* Legacy national Ministry preview is hidden for county project imports. */}
                  {currentImportType?.id === 'national-projects' && mappingSummary.ministries && (
                    <Grid item xs={12} md={6}>
                      <Card variant="outlined" sx={{ '& .MuiCardContent-root': { py: 1.5, '&:last-child': { pb: 1.5 } } }}>
                        <CardContent>
                          <Typography variant="body2" fontWeight={600} gutterBottom sx={{ fontSize: '0.875rem' }}>
                  ...
                  {/* Legacy national State Department preview is hidden for county project imports. */}
                  {currentImportType?.id === 'national-projects' && mappingSummary.stateDepartments && (
                    <Grid item xs={12} md={6}>
                      <Card variant="outlined" sx={{ '& .MuiCardContent-root': { py: 1.5, '&:last-child': { pb: 1.5 } } }}>
                        <CardContent>
                          <Typography variant="body2" fontWeight={600} gutterBottom sx={{ fontSize: '0.875rem' }}>
                ...
                {mappingSummary.rowsWithUnmatchedMetadata.length > 0 && (
                  <Alert severity="warning" sx={{ mt: 1.5, py: 1 }}>
                    ...
                    <Typography variant="caption" sx={{ mt: 0.75, display: 'block', fontSize: '0.75rem' }}>
                      Rows with unknown county departments, directorates, sub-counties, wards, or financial years should be corrected before import. Rows with invalid Sector will still import, but Sector will be left blank.
                    </Typography>
                  </Alert>
                )}
