...
const projectFileChecklistRoutes = require('./routes/projectFileChecklistRoutes');
...
app.use('/api', projectFileChecklistRoutes);
...
app.use('/api/my-tasks', require('./routes/myTasksRoutes'));
