...
const projectEvaluationRoutes = require('./projectEvaluationRoutes');
const projectCidpLinkRoutes = require('./projectCidpLinkRoutes');
...
router.use('/', projectEvaluationRoutes);
router.use('/', projectCidpLinkRoutes);
